...
import ar.com.ensolvers.todo.IntegrationTest;
import ar.com.ensolvers.todo.domain.File;
import ar.com.ensolvers.todo.repository.FileRepository;
...
class FileResourceIT {
    ...
    public static File createEntity(EntityManager em) {
        File file = new File().nombre(DEFAULT_NOMBRE).descripcion(DEFAULT_DESCRIPCION).estado(DEFAULT_ESTADO);
        return file;
    }
    ...
    public static File createUpdatedEntity(EntityManager em) {
        File file = new File().nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION).estado(UPDATED_ESTADO);
        return file;
    }
    ...
    void createFile() throws Exception {
        ...
        assertThat(testFile.getNombre()).isEqualTo(DEFAULT_NOMBRE);
        assertThat(testFile.getDescripcion()).isEqualTo(DEFAULT_DESCRIPCION);
        assertThat(testFile.getEstado()).isEqualTo(DEFAULT_ESTADO);
    }
    ...
    void putNewFile() throws Exception {
        ...
        updatedFile.nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION).estado(UPDATED_ESTADO);
        ...
        File testFile = fileList.get(fileList.size() - 1);
        assertThat(testFile.getNombre()).isEqualTo(UPDATED_NOMBRE);
        assertThat(testFile.getDescripcion()).isEqualTo(UPDATED_DESCRIPCION);
        assertThat(testFile.getEstado()).isEqualTo(UPDATED_ESTADO);
    }
    ...
    void partialUpdateFileWithPatch() throws Exception {
        ...
        partialUpdatedFile.nombre(UPDATED_NOMBRE);
    ...
    void fullUpdateFileWithPatch() throws Exception {
        ...
        partialUpdatedFile.nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION).estado(UPDATED_ESTADO);
